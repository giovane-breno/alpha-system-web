...
export const BenefitsSearch = ({filter, setFilter}) => (
  <Card sx={{ p: 2 }}>
    <Grid container spacing={2}>
      <Grid item xs={8}>
        <TextField fullWidth label="Buscar Benefício" value={filter} onChange={e => setFilter(e.target.value)} variant="outlined" sx={{ maxWidth: 500 }} InputProps={{
