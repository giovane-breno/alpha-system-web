...
import { DeleteModal, DemoteModal, MenuButton, PromoteModal, ViewModal } from './modal/divisoes-actions-modal';

export const DivisoesTable = (props) => {
  const {
    count = 0,
    items = [],
    onDeselectAll,
